              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                  <div>
                    ...
                    Tez Chal.com (Innovative Retail Concepts Private Limited)
                      is India's largest online food and grocery store. With over
                      18,000 products and over a 1000 brands in our catalogue you
                      will find everything you are looking for. Right from fresh
                      Fruits and Vegetables, Rice and Dals, Spices and Seasonings
                      to Packaged products, Beverages, Personal care products,
                      Meats – we have it all.
                    </p>
                  </div>
                ...
                <div>
                  <h2 className="text-xl text-gray-700 mb-4">Happy Shopping</h2>
                  <h2 className="text-xl text-gray-700 mb-4">
                    Why should I use Tez ChalTez Chal.com?
                  </h2>
                  <p className="text-gray-600">
                  Tez Chal.com allows you to walk away from the drudgery of
                    grocery shopping and welcome an easy relaxed way of browsing and
                    shopping for groceries. Discover new products and shop for all
                    your food and grocery needs from the comfort of your home or
                    office.
                  </p>
                </div>
                ...
                <div className="mt-8">
                  <h2 className="text-xl text-gray-700 mb-6">How do I order?</h2>
